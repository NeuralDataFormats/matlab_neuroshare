...
// 
//  JAH: 2014-11-02
//  When compiling with 2014b, mxCreateScalarDouble needed to be changed to
...
// mxCreateDoubleScalar which is still supported.
...
ns_RESULT fOpenFile(char *szFile, mxArray **ppmxFilehandle)
{
    ...
    {
        //Not sure when this function name changed
        //JAH: 2014-11-02
